  ...
  return (
    <>
        ...
        <div style={{backgroundColor: "#101010"}}>
          ...
          <div className='position-relative w-100' style={{borderBottom: "8px solid #CFB991", boxShadow: "0 0 15px rgba(255, 255, 255, 0.7)" }}>
            <img src={cuisineImageMapping[restaurant.tags.cuisine]} style={{ marginTop: "3rem", width: "100%", height: "30rem", objectFit: "cover"}}/>
